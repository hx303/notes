...
Working baseline: `agent/ai-assistant-foundation` at `e7ad19d0fdafc38c90ff19fc24f6fe4b81558b7a`
...
| Account and private workspace | partial | Password auth, account/workspace routes, private knowledge bases/documents, editor, tags, links, sources, versions, publication snapshot UI and admin shell exist. The 39 unchecked account tasks are stale as a source of truth; Wave 1 must test flows and fix gaps rather than rebuild them. |
