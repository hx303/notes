...
The branch may enter Draft PR review. It must not be described as browser-complete, merged, or deployed without fresh browser evidence and the user's explicit merge authorization.
