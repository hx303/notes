...
| P1       | Editor recovery             | Partial: debounce, local backup, reconnect, revision CAS, and recent versions exist      | Persistent offline queue, in-flight serialization, two-tab coordination, 409 comparison choices, and restore of tags/links/sources as a new version |
