...
|     4 | `agent/wave2-orchestration`              | State reconciliation, research, acceptance matrix, and Wave 2 queue             | verifying | Documentation/evidence only; no deployment, paid call, flag change, or merge                   |
|     5 | `agent/migration-version-normalization`  | Forward-only migration namespace repair                                         | waiting   | Preserve applied SQL and production history; clean-project and ledger evidence required        |
