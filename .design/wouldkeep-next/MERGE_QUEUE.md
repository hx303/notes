...
| 1 | `agent/ai-deepseek-provider` / PR #12 | Server-only provider interface and disabled DeepSeek adapter | verifying | 9/9 focused, 154/154 full, build and independent review passed; Draft PR remote checks remain |
