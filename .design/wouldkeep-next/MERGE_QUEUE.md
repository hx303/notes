...
| ---: | --- | --- | --- | --- |
| 0 | `agent/ai-assistant-foundation` / PR #11 | AI consent-first foundation, orchestration baseline, and account/auth stability hotfix | verifying | Account/auth QA passed; signed-in mock success evidence remains, then explicit user approval to mark Ready and merge |
