...
- Next task prerequisites: continue deployed-preview offline/conflict and keyboard evidence when Chrome control and related-data reads are stable. Keep PR #26 Draft; do not mark Ready or merge without the remaining gate and explicit user approval.
