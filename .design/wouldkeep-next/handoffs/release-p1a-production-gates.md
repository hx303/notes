...
- Commands run and raw result summary:
  ...
  - runbook execution surface: all 11 PowerShell blocks passed AST parsing; synthetic helpers accepted the exact pre/post JSON ledgers and single migration, rejected extra, missing, and malformed migration rows, rejected failed activity output, and rejected duplicate fingerprints;
