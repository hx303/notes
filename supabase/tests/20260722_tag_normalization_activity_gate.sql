-- Production-safe, read-only concurrency gate for 20260722000150.
...
SELECT
  'tag_normalization_activity_gate_passed' AS result,
...
UNION ALL
SELECT
  'tag_normalization_activity_gate_failed' AS result,
  300::INTEGER AS max_transaction_age_seconds
FROM activity_risk
CROSS JOIN lock_risk
