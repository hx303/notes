     ...
     OR EXISTS (
       ...
       WHERE namespace.nspname = 'wouldkeep_maintenance'
          OR function.proname IN (
            'open_tag_normalization_00150_permit',
...
AS $tag_normalization_permit_function$
DECLARE
  tags_owner_oid oid;
...
END;
$tag_normalization_permit_function$;

REVOKE ALL ON FUNCTION wouldkeep_maintenance.open_tag_normalization_00150_permit()
  FROM PUBLIC, anon, authenticated, service_role;
COMMENT ON FUNCTION wouldkeep_maintenance.open_tag_normalization_00150_permit() IS
