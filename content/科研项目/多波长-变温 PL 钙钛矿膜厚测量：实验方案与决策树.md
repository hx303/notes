...
**Beer-Lambert 假设的物理验证**：
Bonnin-Ripoll et al. (2019) [BR19] 通过 MC+TMM 对比实验证实：d ≥ 200 nm 时，相干（TMM/Beer-Lambert）与非相干（全 MC）的光学计算误差 **< 2%**。因此：
- d ≥ 200 nm: Beer-Lambert 解析模型物理有效 → 可信任比值法结果
- d < 200 nm: 相干效应不可忽略 → 需验证或升级到 MC 方法
- 150 nm 样品的作用：验证 Beer-Lambert 在薄膜区的**偏离起点**
